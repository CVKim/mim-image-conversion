...
#define M_PROC_CURRENT_VERSION   M_PROC_VERSION_100_PP3
...
#define M_OVERWRITE                                   1861L       // Already defined in mil3dmap.h
...
#define M_NB_ELEMENTS_BIT_SET(X)                      ((M_GET_INTERMOD_VALUE_BITS(X) == M_NB_ELEMENTS) ? true : false)
...
#define M_FEATURE_USER_ARRAY_SIZE_BIT_SET(X)          ((M_GET_INTERMOD_VALUE_BITS(X) == M_FEATURE_USER_ARRAY_SIZE_BITS) ? true : false)
...
#else
#define M_CLIENT_TEXT_ENCODING                        MAKE_INT64(0x0003000000000000)
#define M_CLIENT_ASCII_ENCODING                       MAKE_INT64(0x0001000000000000)
#define M_CLIENT_UTF8_ENCODING                        MAKE_INT64(0x0002000000000000)
#define M_CLIENT_UTF16_ENCODING                       MAKE_INT64(0x0003000000000000)
#endif
...
#endif   // MIL_COMPILE_VERSION < 1060
...
/*                                              to    2576  */
#define M_1394_POWER                                  M_POWER_OVER_CABLE
...
//Reserved for future Intel instruction set expansion 0x0000282CL
//                                                 to 0x00002830L
...
#define M_DIG_INQUIRE_STRING_START                    7700L
   ...
   #define M_GC_CLPROTOCOL_DEVICE_ID_MAX                    (7858L|M_CLIENT_ENCODING)
...
#define M_D12G                                        0x00100000L // Dual link 6 Gbits
...
#define M_CONNECTION_MASTER                              0L
#define M_CONNECTION_EXTENSION1                          1L
#define M_CONNECTION_EXTENSION2                          2L
#define M_CONNECTION_EXTENSION3                          3L
/************************************************************************/
...
#define M_STRICTLY_ROLE_BITS                          (M_ROLE_UNUSED_1 | M_SKIP_PFNC_CHECK | M_ROLE_UNUSED_3 | M_SKIP_PORTABLE_CHECK | M_NO_DMIL_COMPENSATION | M_IS_RETURN_VALUE | M_ALLOW_PSEUDO_ID |M_IN|M_OUT|M_ALLOW_NULL_ID|M_ALLOW_DEFAULT_ID|M_AS_VALUE|M_ALLOW_BUFFER_WITH_REGION)
...
#define M_3DMAP_POINT_CLOUD_CONTAINER                 (M_3DMAP_OBJECT         | 0x00000040L )
...
#define M_CLASS_CONTEXT                                  (M_CLASS_OBJECT         | 0x00000001L )
#define M_CLASS_CONVOLUTIONAL_NETWORK_CONTEXT            (M_CLASS_OBJECT         |  1L )
#define M_CLASS_PRETRAINED_CONTEXT                       (M_CLASS_OBJECT         |  2L )
#define M_CLASS_PRETRAINED_CONVOLUTIONAL_NETWORK_CONTEXT (M_CLASS_OBJECT         |  2L )
#define M_SAVABLE_OBJECT                                 MAKE_INT64(0x0000000000008000)
#define M_CLASS_OBJECT_SAVABLE                           (M_CLASS_OBJECT         | M_SAVABLE_OBJECT)
#define M_CLASS_PREDEFINED_CONVOLUTIONAL_NETWORK_CONTEXT (M_CLASS_OBJECT_SAVABLE |  2L )
#define M_CLASS_CONVOLUTIONAL_NETWORK_TRAIN_CONTEXT      (M_CLASS_OBJECT_SAVABLE |  4L )
#define M_CLASS_CONVOLUTIONAL_NETWORK_DATASET            (M_CLASS_OBJECT_SAVABLE |  8L )
...
#define M_CLASS_CONVOLUTIONAL_NETWORK_RESULT             (M_CLASS_OBJECT         | 32L )
#define M_CLASS_CONVOLUTIONAL_NETWORK_TRAIN_RESULT       (M_CLASS_OBJECT         | 64L )
...
/************************************************************************/
/* Values for M_DATA_INFO_TYPE                                          */
/************************************************************************/
#define M_INTENSITY                                           52L // coming from milbead.h
#define M_INFRARED                                            53L
#define M_ULTRAVIOLET                                         54L
#define M_RANGE                                               55L
#define M_CONFIDENCE                                          56L
#define M_REFLECTANCE                                         57L
#define M_SCATTER                                             58L
#define M_DISPARITY                                           59L
#define M_IDENTIFIED_BY_ID_VALUE                              60L
#define M_MULTISPECTRAL                                       63L
#define M_3D_SCENE                                    0x00000040L
#define M_BUFFER_SEQUENCE                             0x00000080L
...
#define M_COMPONENT_ID_FLAG                           0x00080000
#define M_COMPONENT_ID(N)                             (M_COMPONENT_ID_FLAG | N)
...
#define M_COMPONENT_FLAG                              0x00400000
#define M_COMPONENT(N)                                (M_COMPONENT_FLAG | ((N & 0x1F) << 16))
/************************************************************************/
...
#define M_LAST_PARAM_TYPE                   16 // Always equal to the
...
#define M_CORNER_X(N)                                (1221L + (N))
#define M_CORNER_Y(N)                                (1225L + (N))
...
#define M_ON_CONTAINER                                0x00080000L
...
#define M_MIL_DIRECTORY_INSTALL_SIZE               (M_STRING_SIZE + M_MIL_DIRECTORY_INSTALL)
#define M_MIL_DIRECTORY_EXAMPLES_SIZE              (M_STRING_SIZE + M_MIL_DIRECTORY_EXAMPLES)
#define M_MIL_DIRECTORY_IMAGES_SIZE                (M_STRING_SIZE + M_MIL_DIRECTORY_IMAGES)
#define M_MIL_DIRECTORY_CONTEXTS_SIZE              (M_STRING_SIZE + M_MIL_DIRECTORY_CONTEXTS)
...
#define M_REG_DEF_3_END                          (M_APP_INQUIRE_SYS_START+10305L)
...
#define M_RAPIXOCXP_FINGERPRINT                       M_LIC_FINGERPRINT_TYPE(28)
...
#define M_INTERPRETER_C_PYTHON35          MIL_TEXT("MilInterpPython35.dll")
#define M_INTERPRETER_C_PYTHON34          MIL_TEXT("MilInterpPython34.dll")
...
MIL_DEPRECATED(M_ASSOCIATED_NAME_SIZE, 1060)
...
#define M_IN_BUF_INQUIRE_PTR_RANGE(X)                    (  (X &~ (M_RED | M_GREEN | M_BLUE | M_Y | M_U | M_V)) == M_HOST_ADDRESS            || \
                                                            (X &~ (M_RED | M_GREEN | M_BLUE | M_Y | M_U | M_V)) == M_HOST_ADDRESS_REMOTE     || \
                                                            (X &~ (M_RED | M_GREEN | M_BLUE | M_Y | M_U | M_V)) == M_PHYSICAL_ADDRESS        || \
                                                            (X &~ (M_RED | M_GREEN | M_BLUE | M_Y | M_U | M_V)) == M_PHYSICAL_ADDRESS_REMOTE || \
                                                            (X &~ (M_RED | M_GREEN | M_BLUE | M_Y | M_U | M_V)) == M_HOST_ADDRESS            || \
                                                            (X &~ (M_RED | M_GREEN | M_BLUE | M_Y | M_U | M_V)) == M_HOST_ADDRESS            || \
                                                            (X == M_DC_HANDLE) || \
                                                            (X == M_DIB_HANDLE) )

#define M_IN_BUF_INQUIRE_STRING_RANGE(X)                 (!(X == X)) // Return false for now.
...
#define M_IN_DIG_INQUIRE_MIL_INT64_RANGE(X)              ((((X&~(M_INTERMOD_VALUE_MASK|M_DIG_CONTROL_TYPE_RESERVED_BIT_MASK)) >= M_DIG_INQUIRE_SIZEOF_INT64_START ) &&      \
                                                           ...
                                                           ((X&~(M_INTERMOD_VALUE_MASK|M_DIG_CONTROL_TYPE_RESERVED_BIT_MASK|M_COMPONENT(31))) == M_DATA_INFO_TYPE      )  || \
...
#endif // PFNC_MONO
#endif //_PFNC_
#endif //MIL_COMPILE_VERSION < 1100
