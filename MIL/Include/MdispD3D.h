...
-----------
  ...
  The default convention of the look at position of this display is MD3D_DX,
  i.e. a left-hand rule coordinate system.
...
MIL_DISP_D3D_HANDLE MPtCldD3DAlloc(MIL_ID MilPointCloudContainer,
...
Description
-----------
  This function allocates an object that can display the 3d point clouds
  into a point cloud container. If the intensity information is available, the
  vertex will use this color in the 3D display. If no intensity is available, the 
  vertex color will be proportional to its Z coordinate. It is possible to
  display the intensity(or Z) value using a Jet LUT color mapping. For height
  coordinates, the color will auto-scale itself to the Z dynamic. For intensity
  values, if the maximum intensity is greater than 255, the colors will auto-scale
  based on the intensity dynamic.

  If defined, the extraction box of the point cloud can also be displayed.

  The default convention of the look at position of this display is MD3D_MIL,
  i.e. a right-hand rule coordinate system.
  
MilPointCloudContainer
  MIL ID of PointCloudContainer,
...
DisplaySizeY
     Dialog Size Y
 -----------------------------------------------------------------------------------
void MPtCldD3DSetPointCloud(MIL_DISP_D3D_HANDLE DisplayID, MIL_ID MilPointCloudContainer,MIL_INT LabelIndex,bool UseColorLut
)

Description
-----------
  Resets the point cloud displayed by the display.

DisplayID [in]
  The D3D display handle returned by MdispD3DAlloc().

MilPointCloudContainer [in]
  MIL_ID of container.
...
extern "C"
   ...
   //!
   //! \param  [in]    : MIL ID of PointCloudContainer,
   //! \param DisplaySizeX [in]   : Dialog Size X
   //! \param DisplaySizeY [in]   : Dialog Size Y
   //!
   ////////////////////////////////////////////////////////////////////////////////
   MIL_DISP_D3D_HANDLE MPtCldD3DAlloc(MIL_ID MilPointCloudContainer, MIL_INT LabelIndex, bool UseColorLut,
                                      MIL_INT DisplaySizeX, MIL_INT DisplaySizeY,
                                      MIL_WINDOW_HANDLE WindowHandle);
   ////////////////////////////////////////////////////////////////////////////////
   //!  Name         : MPtCldD3DSetPointCloud
   //! \brief Resets the point cloud displayed by the display
   //!
   //! \param DisplayID [in]                 : D3D handle of the 3d display.
   //! \param MilPointCloudContainer [in]    : MilID of container.
   //!
   ////////////////////////////////////////////////////////////////////////////////
   void MPtCldD3DSetPointCloud(MIL_DISP_D3D_HANDLE DisplayID, MIL_ID MilPointCloudContainer, MIL_INT LabelIndex, bool UseColorLut);
   ////////////////////////////////////////////////////////////////////////////////
   ...
   /************************************************************************/
   /* 3d display control/inquire defines                                  */
   /************************************************************************/
   #define MD3D_ROTATE                          M_ROTATE
   #define MD3D_POINT                           M_POINT
   #define MD3D_LUT                             M_LUT
   #define MD3D_VOLUME                          M_VOLUME
   #define MD3D_BOX                             M_BOX
   #define MD3D_CAMERA                          M_CAMERA
   #define MD3D_RELATIVE_COORDINATE_SYSTEM      M_RELATIVE_COORDINATE_SYSTEM
   #define MD3D_LASER_LINE_COORDINATE_SYSTEM    M_LASER_LINE_COORDINATE_SYSTEM
   #define MD3D_IMAGE                           M_IMAGE

  
   #define MD3D_LOOK_AT_X                       8L
   #define MD3D_LOOK_AT_Y                       9L
   #define MD3D_LOOK_AT_Z                       10L
   #define MD3D_EYE_DIST                        11L
   #define MD3D_EYE_THETA                       12L
   #define MD3D_EYE_PHI                         13L
   #define MD3D_LOOK_AT_CONVENTION              14L 
   #define MD3D_DX                              15L
   #define MD3D_MIL                             16L

   #define MD3D_SUBSAMPLE_X                     M_SUBSAMPLE_X
   #define MD3D_SUBSAMPLE_Y                     M_SUBSAMPLE_Y
   #define MD3D_SUBSAMPLE                       M_SUBSAMPLE

   #define MD3D_TRUE                            M_TRUE
   #define MD3D_FALSE                           M_FALSE
   #define MD3D_ENABLE                          M_ENABLE
   #define MD3D_DISABLE                         M_DISABLE
   #define MD3D_GRAYSCALE                       M_GRAYSCALE
   #define MD3D_COLOR                           M_COLOR
   #define MD3D_INTENSITY                       M_INTENSITY
   #define MD3D_NONE                            M_NONE
   #define MD3D_TRANSPARENT                     M_TRANSPARENT
   #define MD3D_OPAQUE                          M_OPAQUE
   
   #define MD3D_DEFAULT                         M_DEFAULT
   #define MD3D_GENERAL                         M_GENERAL
   ...
   //!                            MD3D_ROTATE :                         MD3D_TRUE
   //!                                                                  MD3D_FALSE
   //!                            MD3D_POINT  :                         MD3D_ENABLE
   //!                                                                  MD3D_DISABLE   
   //!                            MD3D_LUT    :                         MD3D_GRAYSCALE
   //!                                                                  MD3D_COLOR
   //!                                                                  MD3D_INTENSITY    
   //!                            MD3D_VOLUME :                         MD3D_NONE
   //!                                                                  MD3D_TRANSPARENT
   //!                                                                  MD3D_OPAQUE
   //!                            MD3D_BOX:                             MD3D_NONE
   //!                                                                  MD3D_TRANSPARENT
   //!                                                                  MD3D_OPAQUE
   //!                            MD3D_CAMERA :                         MD3D_ENABLE
   //!                                                                  MD3D_DISABLE
   //!                            MD3D_RELATIVE_COORDINATE_SYSTEM :     MD3D_ENABLE
   //!                                                                  MD3D_DISABLE
   //!                            MD3D_LASER_LINE_COORDINATE_SYSTEM :   MD3D_ENABLE
   //!                                                                  MD3D_DISABLE
   //!                            MD3D_IMAGE :                          MD3D_ENABLE
   //!                                                                  MD3D_DISABLE
   //!                            MD3D_LOOK_AT_CONVENTION:              MD3D_MIL
   //!                                                                  MD3D_DX                                                                  
   //!                            MD3D_LOOK_AT_X                 
   //!                            MD3D_LOOK_AT_Y                 
   //!                            MD3D_LOOK_AT_Z                 
   //!                            MD3D_EYE_DIST                  
   //!                            MD3D_EYE_THETA                     
   //!                            MD3D_EYE_PHI     :                    MD3D_DEFAULT or Values
   //!
   ////////////////////////////////////////////////////////////////////////////////   
   ...
   //!                            MD3D_EYE_DIST                  
   //!                            MD3D_EYE_THETA                 
   //!                            MD3D_EYE_PHI     :                    M_DEFAULT or Values
   //!
   ////////////////////////////////////////////////////////////////////////////////   
