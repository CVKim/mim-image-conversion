...
#define M_AUG_GAMMA_OFFSET_BAND_0                         3368L // TBR: once DOC-10970 done.  
#define M_AUG_GAMMA_VALUE_BAND_1                          3369L
#define M_AUG_GAMMA_OFFSET_BAND_1                         3370L // TBR: once DOC-10970 done.  
#define M_AUG_GAMMA_VALUE_BAND_2                          3371L
#define M_AUG_GAMMA_OFFSET_BAND_2                         3372L // TBR: once DOC-10970 done.  
...
/* MimEdgeDetect()                                                      */
/************************************************************************/
#if M_MIL_LITE || MIL_COMPILE_VERSION >= 1060
...
#define M_AUG_LIGHTING_DIRECTIONAL_OP_OFFSET          2904L // TBR: once DOC-10961 done.
...
#define M_AUG_GAMMA_OP_OFFSET                         2964L // TBR: once DOC-10970 done.
#define M_AUG_GAMMA_OP_OFFSET_DELTA                   2965L // TBR: once DOC-10970 done.
...
MIL_DLLFUNC void MFTYPE MimAugment(MIL_ID    DataAugmentContextImId,
                                       MIL_ID    SrcImageBufId,
                                       MIL_ID    DstImageBufId,
                                       MIL_INT64 SeedValue,
                                       MIL_INT64 ControlFlag);
...
inline bool M_IN_IM_INQUIRE_DOUBLE_RANGE(MIL_ID ContextOrResultId, MIL_INT64 InquireType)
   ...
   switch (InquireType & M_MASK_MIM_INQUIRE_TYPE)
      ...
      case M_AUG_LIGHTING_DIRECTIONAL_OP_OFFSET:
      ...
      case M_AUG_GAMMA_OP_OFFSET:
      case M_AUG_GAMMA_OP_OFFSET_DELTA:
...
inline bool IsAugmentResult(MIL_INT64 ResultType, MIL_INT64* ResultDataType)
   ...
   switch(ResultTypeStripped)
      ...
      case M_AUG_GAMMA_OFFSET_BAND_0:
      case M_AUG_GAMMA_VALUE_BAND_1:
      case M_AUG_GAMMA_OFFSET_BAND_1:
      case M_AUG_GAMMA_VALUE_BAND_2:
      case M_AUG_GAMMA_OFFSET_BAND_2:
