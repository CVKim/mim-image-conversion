...
inline MIL_ID MFTYPE McalRestoreW(const MIL_STRING& FileName, MIL_ID SystemId, MIL_INT64   ControlFlag, MIL_ID* CalibrationIdPtr)
   {
   return McalRestoreW(FileName.c_str(), SystemId, ControlFlag, CalibrationIdPtr);
   }
...
inline MIL_ID MFTYPE McalRestoreA(const MIL_STRING& FileName, MIL_ID SystemId, MIL_INT64   ControlFlag, MIL_ID* CalibrationIdPtr)
   {
   return McalRestoreA(FileName.c_str(), SystemId, ControlFlag, CalibrationIdPtr);
   }
...
inline MIL_ID MFTYPE McalRestore(const MIL_STRING& FileName, MIL_ID SystemId, MIL_INT64   ControlFlag, MIL_ID* CalibrationIdPtr)
   {
   return McalRestore(FileName.c_str(), SystemId, ControlFlag, CalibrationIdPtr);
   }
