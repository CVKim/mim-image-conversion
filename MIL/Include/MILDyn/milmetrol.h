...
#define M_NUMBER_OF_POINTS                   M_NUMBER                   // Deprecated.
...
MIL_DEPRECATED(M_NUMBER_OF_POINTS,1020)
...
/* MmetPut()                                                      */
/***************************************************************************/
MIL_METROL_DLLFUNC void MFTYPE    MmetPut(MIL_ID        ContextMetId,
                                     MIL_INT            LabelOrIndex,
...
inline void MFTYPE MmetPut(MIL_ID           ContextMetId,
   ...
   {
#if M_MIL_USE_SAFE_TYPE
   if(!ChainIndexArrayPtr.IsValidParam() ||
      !PosXArrayPtr.IsValidParam()       ||
      !PosYArrayPtr.IsValidParam()       ||
      !AngleArrayPtr.IsValidParam()      ||
      !ValueArrayPtr.IsValidParam())
      {
      SafeTypeError(MIL_TEXT("MmetPut"), MIL_TEXT("Input ArrayPtrs cannot be an non zero integer!"));
      }
   if((ChainIndexArrayPtr.Size<MIL_INT>() != PosXArrayPtr.Size<MIL_DOUBLE>() && !ChainIndexArrayPtr.IsNullPtr() && !PosXArrayPtr.IsNullPtr())   ||
      (ChainIndexArrayPtr.Size<MIL_INT>() != PosYArrayPtr.Size<MIL_DOUBLE>() && !ChainIndexArrayPtr.IsNullPtr() && !PosYArrayPtr.IsNullPtr())   ||
      (ChainIndexArrayPtr.Size<MIL_INT>() != AngleArrayPtr.Size<MIL_DOUBLE>() && !ChainIndexArrayPtr.IsNullPtr() && !AngleArrayPtr.IsNullPtr()) ||
      (ChainIndexArrayPtr.Size<MIL_INT>() != ValueArrayPtr.Size<MIL_DOUBLE>() && !ChainIndexArrayPtr.IsNullPtr() && !ValueArrayPtr.IsNullPtr()) ||
      (PosXArrayPtr.Size<MIL_DOUBLE>() != PosYArrayPtr.Size<MIL_DOUBLE>() && !PosXArrayPtr.IsNullPtr() && !PosYArrayPtr.IsNullPtr())            ||
      (PosXArrayPtr.Size<MIL_DOUBLE>() != AngleArrayPtr.Size<MIL_DOUBLE>() && !PosXArrayPtr.IsNullPtr() && !AngleArrayPtr.IsNullPtr())          ||
      (PosXArrayPtr.Size<MIL_DOUBLE>() != ValueArrayPtr.Size<MIL_DOUBLE>() && !PosXArrayPtr.IsNullPtr() && !ValueArrayPtr.IsNullPtr())          ||
      (PosYArrayPtr.Size<MIL_DOUBLE>() != AngleArrayPtr.Size<MIL_DOUBLE>() && !PosYArrayPtr.IsNullPtr() && !AngleArrayPtr.IsNullPtr())          ||
      (PosYArrayPtr.Size<MIL_DOUBLE>() != ValueArrayPtr.Size<MIL_DOUBLE>() && !PosYArrayPtr.IsNullPtr() && !ValueArrayPtr.IsNullPtr())          ||
      (AngleArrayPtr.Size<MIL_DOUBLE>() != ValueArrayPtr.Size<MIL_DOUBLE>() && !AngleArrayPtr.IsNullPtr() && !ValueArrayPtr.IsNullPtr()))
      {
      SafeTypeError(MIL_TEXT("MmetPut"), MIL_TEXT("The input vectors must have the same size!"));
      }
   if(ChainIndexArrayPtr.IsEmpty<MIL_INT>() ||
      PosXArrayPtr.IsEmpty<MIL_DOUBLE>()    ||
      PosYArrayPtr.IsEmpty<MIL_DOUBLE>()    ||
      AngleArrayPtr.IsEmpty<MIL_DOUBLE>()   ||
      ValueArrayPtr.IsEmpty<MIL_DOUBLE>())
      {
   ...
   if(!PosXArrayPtr.IsNullPtr() && PosXArrayPtr.GetMilDataType() != MilTraits<MIL_DOUBLE>::TypeFlag)
      {
      SafeTypeError(MIL_TEXT("MmetPut"), MIL_TEXT("The data type of PosXArrayPtr must be MIL_DOUBLE."));
      }
   if(!PosYArrayPtr.IsNullPtr() && PosYArrayPtr.GetMilDataType() != MilTraits<MIL_DOUBLE>::TypeFlag)
      {
      SafeTypeError(MIL_TEXT("MmetPut"), MIL_TEXT("The data type of PosYArrayPtr must be MIL_DOUBLE."));
      }
   if(!AngleArrayPtr.IsNullPtr() && AngleArrayPtr.GetMilDataType() != MilTraits<MIL_DOUBLE>::TypeFlag)
      {
      SafeTypeError(MIL_TEXT("MmetPut"), MIL_TEXT("The data type of AngleArrayPtr must be MIL_DOUBLE."));
      }
   if(!ValueArrayPtr.IsNullPtr() && ValueArrayPtr.GetMilDataType() != MilTraits<MIL_DOUBLE>::TypeFlag)
      {
      SafeTypeError(MIL_TEXT("MmetPut"), MIL_TEXT("The data type of ValueArrayPtr must be MIL_DOUBLE."));
      }
#endif

   MIL_INT NumEdgelsOrPointsMax = !ChainIndexArrayPtr.IsNullPtr() ? ChainIndexArrayPtr.Size<MIL_INT>() :
                                  !PosXArrayPtr.IsNullPtr() ? PosXArrayPtr.Size<MIL_DOUBLE>() :
                                  !PosYArrayPtr.IsNullPtr() ? PosYArrayPtr.Size<MIL_DOUBLE>() :
                                  !AngleArrayPtr.IsNullPtr() ? AngleArrayPtr.Size<MIL_DOUBLE>() :
                                  !ValueArrayPtr.IsNullPtr() ? ValueArrayPtr.Size<MIL_DOUBLE>() : M_NULL;
